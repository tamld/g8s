...
| D4 | Version const blocked goreleaser ldflags -X injection — CLOSED 2026-08-25: converted to var (commit 749084c); release.yml version-assertion step greps the var value so tag/source mismatch fails the build |
